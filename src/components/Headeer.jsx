        ...
        <div className="flex items-center gap-3 px-5 py-6">
          ...
          <div className="h-12.5 min-w-0 flex-1 rounded-full border border-gray-200">
            ...
            <input
              type="text"
              placeholder="Search"
              className="h-full w-full rounded-full px-5 py-3 text-base outline-none placeholder:text-gray-300"
            />
          ...
          <button
            type="button"
            aria-label="Search"
            className="flex h-12.5 w-12.5 shrink-0 items-center justify-center rounded-full bg-green-600 text-white"
          >
            <FaSearch size={20} />
          </button>
