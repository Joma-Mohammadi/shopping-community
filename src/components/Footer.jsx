...
export default function Footer() {
    ...
    return (
        <footer className="relative bg-[#071411] pt-38.75 text-white">
            ...
            <div className="absolute left-1/2 top-0 w-[calc(100%-32px)] max-w-400 -translate-x-1/2 
               -translate-y-1/2 rounded-[15px] bg-[#075039] px-10 py-11 md:px-10">
            ...
            <div className="mx-auto max-w-400 px-8 pb-10 mt-20">
                                    ...
                                    >
                                        {column.map((link) => (
                                            <Link
                                                key={link.path}
                                                to={link.path}
                                                className="block text-[14px] leading-4 text-[#9D9EA2] transition hover:text-white"
                                            >
                                                {link.title}
                                            </Link>
                                        ))}
                ...
                <div className="mt-10 border-t border-gray-400 pt-6">
                    ...
                    <div className="flex flex-col justify-between gap-5 text-[14px] text-gray-400 md:flex-row">
