        ...
        <footer className="relative bg-[#071411] pt-38.75 text-white">
            ...
            >
                ...
                <form
                    ...
                    className=" mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-3 md:gap-4 ">
                    <input
                        type="email"
                        value={email}
                        onChange={(event) => setEmail(event.target.value)}
                        placeholder={footerData.newsletter.placeholder}
                        className=" h-14.5 w-full min-w-0 rounded-full border border-white/20 bg-transparent px-5
                            text-[11px] text-white outline-none placeholder:text-white/35 focus:border-white/40 sm:flex-1 sm:px-6 md:px-7 "/>

                    <button
                        type="submit"
                        className=" h-14.5  w-full shrink-0  rounded-full bg-[#17AF26] px-5
                            text-sm font-medium text-white sm:w-auto sm:px-6 md:px-8">
            ...
            <div className="mx-auto mt-20 max-w-400 px-8 pb-10">
                        ...
                        <div className="space-y-3">
                            {footerData.quickLinks.links.map((link) => (
                                <Link
                                    key={link.path}
                                    to={link.path}
                                    className=" block text-[14px] text-[#9D9EA2] transition hover:text-white">
                                    {link.title}
                                </Link>
                            ))}
                        </div>
                ...
                <div className="mt-10 border-t border-gray-400 pt-6">
                    <div
                        className=" flex flex-col justify-between gap-5 text-[14px] text-gray-400 md:flex-row ">
