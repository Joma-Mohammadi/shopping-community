...
export default function WhyUsItem({ feature }) {
  ...
  return (
    <section
      className="
        flex min-h-82.5 flex-col rounded-[10px]
        border border-[#e5e7e9] bg-white
        px-7 py-9 transition duration-300
        hover:-translate-y-1
        hover:shadow-[0_12px_30px_rgba(0,0,0,0.05)]
        sm:min-h-86.25 sm:px-8 sm:py-10
        lg:min-h-87 lg:px-7.25 lg:py-10">
      {/* Icon */}
      ...
      <p
        className="
          mt-5 max-w-82.5 text-[14px]
          leading-[1.48] text-[#737780]
          sm:text-[14px] sm:leading-normal
        "
      >
        {feature.description}
      </p>
